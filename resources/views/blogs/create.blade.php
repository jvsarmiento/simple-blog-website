        ...
        <section class="my-5">
            <div class="row">
                <div class="col-sm-12 col-md-6 mx-auto">
                    ...
                    <hr>
                    <form class="my-5" method="POST" action="{{ route('blogs.store') }}" novalidate>
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="3" required></textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
